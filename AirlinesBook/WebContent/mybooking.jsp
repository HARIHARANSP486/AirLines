...
<body>
	...
	<div class="topnav">
		...
		<a class="active-non" href="ticketstatus.jsp">Ticket Status</a> <a
			class="active" href="cancelticket.jsp">Cancel Ticket</a> <a
...
<form method="post" action="CancelBookingServlet">
			...
			<table>
				<tbody>
					...
					<tr>
						<td></td>
						<td>&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="submit" class="btn btn-info" style="width: 450px">IN
								NEXT PAGE YOU WIL GET THE PASSENGERS DETAILS</button> <br>
						</td>
					</tr>
				</tbody>
			</table>
	...
	<div class="hero-back">
		<a href=cancelticket.jsp class="btn btn-info" role="button">BACK</a>
	</div>
	<!-- <table>
		<tbody>
...
<!-- <table>
			<tbody>
				...
				<tr>
					<td></td>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<button type="submit" style="width: 80px">cancel</button> <br>
					</td>
				</tr>
			</tbody>
		</table> -->