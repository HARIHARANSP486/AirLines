...
body {
	background-image: url("Takeoff-Flight-Images.jpg");
	height: 400px;
	background-position: center;
	background-size: cover;
	position: relative;
...
<body>
	...
	<center>
		<h3>
			<b>Enter the Booking Id to Continue Ticket Booking</b>
		</h3>
	</center>
	<form method="post" action="TicketCancelServlet">
		<div class="hero-context">
			<table>
				<tbody>
					<tr align="center">
						<td style="color: black"><b>Book Id:</b></td>
