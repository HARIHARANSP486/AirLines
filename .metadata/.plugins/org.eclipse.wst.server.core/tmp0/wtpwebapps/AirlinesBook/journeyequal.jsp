...
<body>
	...
	<div class="topnav">
		<a class="active" href="menupage.jsp">Home </a> <a class="active-non"
			href="flightsearch.jsp">Available Flights</a> <a class="active-non"
			href="singletrip.jsp">New ticket Booking</a>
	...
	<!-- <h2>
		<b>This web site is used to book tickets ,check the ticket status
			and cancel the ticket </b>
	</h2> -->
	<br>
	<h2>Your source and destination is equal.Please enter valid
		information.
</body>
</body>
</html>
