...
body {
	background-image: url("airflight.jpg");
	height: 650px;
	background-position: center;
	background-size: cover;
	position: relative;
...
<body>
	...
	<div class="topnav">
		<a class="active-non" href="menupage.jsp">Home <span
			...
			class="active-non" href="singletrip.jsp">New ticket Booking</a>
	...
	<center>
		<h2>
			<b>Enter the Booking Id to Check the ticket status</b>
		</h2>
	</center>
	<div class="container">
		<form method="post" action="TicketStatusServlet">
